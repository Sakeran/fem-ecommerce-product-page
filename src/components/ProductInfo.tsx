    ...
    <div class="w-full flex flex-col p-6">
      ...
      <div class="order-2 md:flex md:gap-4">
        ...
        <div class="mt-4 md:mt-0 md:grow">
          <button class="w-full min-h-[3.5rem] text-white font-bold bg-orange-500 hover:bg-orange-700 focus-visible:bg-orange-700 rounded-xl flex items-center justify-center shadow-cta transition-colors duration-150 ease-in-out">
